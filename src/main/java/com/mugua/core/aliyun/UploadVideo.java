...
public class UploadVideo {
    ...
    private static String accessKeyId = "LTAIGWIEq1pTrHVm";
    private static String accessKeySecret = "VeRlTjODROkkMbsPkkrNklJPvmxtGs";
    private static  DefaultAcsClient aliyunClient= new DefaultAcsClient(
    ...
    private static String createUploadVideo(DefaultAcsClient client) {
        ...
        try {
        	  ...
        	  log.error(">>>>>>>>>>>>>>>>>>>>>");
			  log.error("阿里云错误:CreateUploadVideoRequest Server Exception:"+e.getErrMsg());
